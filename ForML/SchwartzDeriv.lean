...
lemma iteratedPDeriv_eq_iteratedFDeriv {n : ℕ} {m : Fin n → E} {f : 𝓢(E, F)} {x u w : E} :
  ...
  | succ n h_ind =>
    ...
    conv => lhs; arg 1; arg 3; intro y; simp
    exact iteratedFDeriv_fderiv_apply (f.smooth n.succ)
